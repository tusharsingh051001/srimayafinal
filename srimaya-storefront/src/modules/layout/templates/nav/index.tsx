...
//         <div className="w-full bg-white px-4 py-3 font-bloverly ">
//           <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between">
//             {/* Left Navigation (only show on md+) */}
//             <nav className="hidden md:flex items-center space-x-6 md:space-x-16">
//               <Link
//                 href="/"
//                 className="font-cormorant text-3xl hover:text-gray-900 transition-colors duration-200"
//               >
...
//             {/* Center Logo */}
//             <Link href="/" className="my-4 md:my-0">
//               <div className="relative w-48 h-16 hidden md:flex">
//                 <Image
//                   src="/logo/image.png"
//                   alt="Logo"
//                   layout="intrinsic"
...
//             {/* Right Navigation (only show on md+) */}
//             <nav className="hidden md:flex items-center space-x-6 md:space-x-12">
//               <Link
//                 href="/collections"
//                 className="font-cormorant text-3xl hover:text-gray-900 transition-colors duration-200"
//               >
